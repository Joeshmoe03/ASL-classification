...
python train.py -nepoch 15 -batchSize 32 -lr 0.001 -metric accuracy -val 0.2 -data_dir ./data/asl_alphabet_train/asl_alphabet_train/ -img_size 64 -momentum 0.000009 -model convnet0
